...
\begin{figure}[ht]
  \centering
  \subfloat[Tacking Maneuver \cite{denny2009float}.] {\includegraphics[width=0.45\textwidth]{tacking.png}\label{fig:tacking}}
  \hfill
   \centering
  \subfloat[ ]{\includegraphics[width=0.35\textwidth]{symetry_traj.png}\label{tack_jib}}
