...
\begin{figure}[ht]
  \centering
  \subfloat[Olympic Clases ] {\includegraphics[width=0.32\textwidth]{olym_classes.png}\label{olymp_c}}
  \hfill
...
\begin{figure}[ht]
  \centering
  \subfloat[Trapezoid Course ] {\includegraphics[width=0.53\textwidth]{trap_course.png}\label{trap_c}}
  \hfill
  \subfloat[Windward / leeward course] {\includegraphics[width=0.25\textwidth]{l_w.png} \label{wl_c}}
  \caption{Types of courses \cite{instr_rio}.}
\label{typecourses} 
\end{figure}

%starting line must be set up at dead-downwind direction of Buoy 1 no matter using any race route
%The regatta will consist of an opening series and, provided a minimum of 6 races have been completed in the opening series, a medal rac
